...
Please note that the `AltCNLS-Python` can only be applied in the applications of additive error term. For most applications in multiplicative one, please go to our other developing [StoNED-Python](https://github.com/ds2010/StoNED-Python) project.
